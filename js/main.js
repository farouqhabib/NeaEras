...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    const ssMenuToggle = function() {
        ...
        const menuItems = document.querySelectorAll('.fullscreen-menu a'); // Select all menu items
    ...
    const ssGsapAnimations = function() {
    ...
    * ------------------------------------------------------ */
    (function ssInit() {
        ...
        ssMoveTo();
        ssMenuToggle();
        ssGsapAnimations();  // Call the new function here
